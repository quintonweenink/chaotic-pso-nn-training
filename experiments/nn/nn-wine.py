...
training, generalization, testing = dataSetTool.getHeartDataSets('../../dataSet/wine/wine.data')
...
hiddenLayer = Layer(bounds, size = 10, prev = inputLayer, l_rate = l_rate, bias = True, label = "Hidden layer")
